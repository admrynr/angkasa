                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
							...
							if(!empty($subarea[0]['kode_subarea']))
							{
                                ...
                                <div class="col-lg-6">		
									 <?php 
										...
										?>
											...
											<input class="form-control" type="hidden" name="kode_subarea" value="<?php echo isset($subarea[0]['kode_subarea'])?$subarea[0]['kode_subarea']:'';?>" <?php echo $disabled;?>>
