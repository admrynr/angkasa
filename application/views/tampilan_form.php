                ...
                <div class="p-5">
                  ...
                  <form class="user" method="post" action="<?php echo base_url(); ?>form/ceksubmit">
                    ...
                    <div class="container bg-light text-dark rounded-sm" id="penilaian" aria-describedby="info">
                      <br>
                      <div class="form-group">
                        <p >1. Apakah lantai bersih dari debu ?</p>
                    ...
                    <div class="form-group">
                      <p >2. Apakah langit-langit bebas dari jaring laba-laba ?</p>
                    <div class="form-check form-check-inline">
                    ...
                    <div class="form-check form-check-inline">
                      <input class="form-check-input" type="radio" name="inlineRadioOptions2" id="inlineRadio4" value="1">
                      <label class="form-check-label" for="inlineRadio4">Iya</label>
                    </div>
                    </div>


                    <div class="form-group">
                      <p >3. Apakah jendela bebas dari noda ?</p>
                    <div class="form-check form-check-inline">
                      <input class="form-check-input" type="radio" name="inlineRadioOptions3" id="inlineRadio5" value="0">
                      <label class="form-check-label" for="inlineRadio5">Tidak</label>
                    </div>
                    <div class="form-check form-check-inline">
                      <input class="form-check-input" type="radio" name="inlineRadioOptions3" id="inlineRadio6" value="1">
                      <label class="form-check-label" for="inlineRadio6">Iya</label>
                    </div>
                    <br>
                  </div>
                  <div class="input-group mb-3">
                    ...
                    <input type="text" class="form-control" name="totalSum" readonly aria-describedby="basic-addon1">
                  </div>
